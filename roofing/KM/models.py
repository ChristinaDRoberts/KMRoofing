...
class BlogPageGalleryImage(Orderable):
    page = ParentalKey(ServicesPage, on_delete=models.CASCADE, related_name='gallery_images')
...
class ServicesTagIndexPage(Page):

    def get_context(self, request):

        # Filter by tag
        tag = request.GET.get('tag')
        servicespages = ServicesPage.objects.filter(tags__name=tag)
